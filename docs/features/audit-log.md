...
- Da fare: retention/rotazione configurabile (default 90 giorni, poi archiviazione), notifica email per eventi critici (v2, collegato a [notifications.md](notifications.md)).
