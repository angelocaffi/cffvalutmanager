...
- [ ] Gestione password: CRUD + generatore ([features/password-manager.md](features/password-manager.md))
- [ ] Gestione carte di credito: CRUD + mascheramento ([features/credit-cards.md](features/credit-cards.md))
